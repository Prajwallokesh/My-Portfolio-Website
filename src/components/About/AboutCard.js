      ...
      <Card.Body>
        <blockquote>
          <p style={{ textAlign: "left",fontSize:"19px" }}>
           ...
           <br /> Motivated and detail-oriented pre-final year Computer Science student with a strong foundation in software development, data structures, and cloud technologies. Seeking opportunities to contribute technical skills to real-world projects and continue growing as a full-stack developer.
            <br />
            <br />
